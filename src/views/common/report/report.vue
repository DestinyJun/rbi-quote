...
<!--                    <Input v-model="updateReport.valuationPurpose" placeholder="请输入估价目的" style="display: inline-block"></Input>-->
              ...
              <Col span="10">
                <FormItem label="估价结果" prop="valuationResult" :label-width="100">
                  <Col span="22">
                    <Input v-model="updateReport.valuationResult" placeholder="请输入估价结果" style="display: inline-block"></Input>
                  </Col>
                </FormItem>
              </Col>
            </Row>
            <Row>
              <Col span="10">
                <FormItem label="估价师1" prop="valuer1" :label-width="100">
                  <Col span="22" style="text-align: left" >
                    <Select v-model="updateReport.valuer1"  @on-open-change="addRoportSelectAutor('valuer1', 'update')" @on-change="addReportChangeAutor('valuer1', 'update')">
                      <Option v-for="(item, index) in addConfig.appraiserOneList" :value="item.value" :key="index" >{{ item.label }}</Option>
                    </Select>
                  </Col>
                </FormItem>
              ...
              <Col span="10">
                <FormItem label="估价师2" prop="valuer2" :label-width="100">
                  <Col span="22" style="text-align: left">
                    <Select v-model="updateReport.valuer2" @on-open-change="addRoportSelectAutor('valuer2', 'update')" @on-change="addReportChangeAutor('valuer2', 'update')">
                      <Option v-for="item in addConfig.appraiserTwoList" :value="item.value" :key="item.value" >{{ item.label }}</Option>
                    </Select>
                  </Col>
                </FormItem>
            ...
            <Row>
              <Col span="10">
                <FormItem label="价值时间" prop="valuationDate" :label-width="100">
                  <Col span="30" style="text-align: left">
                    <DatePicker type="date" placeholder="选择日期" format="yy-MM-dd" style="width: 92%" v-model="updateReport.valuationDate"></DatePicker>
                  </Col>
                </FormItem>
              </Col>
              <Col span="10">
                <FormItem label="估价有效期" prop="valuationValidityBegin" :label-width="100">
                  <Col span="30" style="text-align: left">
                    <DatePicker type="daterange" format="yy-MM-dd" placeholder="选择时间段" style="width: 92%" v-model="updateReport.valuationValidityBegin"></DatePicker>
                  </Col>
                </FormItem>
              </Col>
            </Row>
...
<!--                  </Col>-->
            ...
            <Row>
              <Col span="20" >
                <FormItem label="报告摘录" prop="excerpt" :label-width="100">
                  <Col span="18">
                    <Input v-model="updateReport.excerpt" maxlength="300" show-word-limit type="textarea" placeholder="报告摘录以及特征描述..."/>
                  </Col>
                </FormItem>
              </Col>
            </Row>
