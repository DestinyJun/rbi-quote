<template>
  <div id="thrReview" class="thrReview">
    ...
    <div class="review-modal">
      <!-- 详情-->
      <Modal v-model="reviewDetailModal" draggable scrollable :transfer="false"  width="960" :styles="{top: '150px'}" :closable="false">
        ...
        <div style="text-align:center;padding: 0 2vw">
          <Row>
            <Col span="12">
              ...
              <Col span="3" style="line-height: 3vh">
                <span style="display: inline-block;width: 18vw;height: 3vh;text-align: left">{{detailThreeReport.valuationObject}}</span>
              </Col>
            </Col>
            <Col span="12">
              <Col span="6" style="line-height: 3vh;text-align: right">
              ...
              <Col span="3" style="line-height: 3vh">
                <span style="display: inline-block;width: 18vw;height: 3vh;text-align: left">{{detailThreeReport.valuationObjectAddress}}</span>
              </Col>
            </Col>
          </Row>
          <Row>
          ...
          <Row style="margin: 0.5vh">
            <Col span="10" >
              ...
              <Col span="12"  style="line-height: 3vh">
                <span style="display: inline-block;padding:0 0 0 3px; width: 100%;height: 3vh;text-align: left;border-radius: 3px; border: 1px solid #EEEEEE">{{detailThreeReport.valuationPurpose}}</span>
              </Col>
            ...
            <Col span="10">
              ...
              <Col span="12"  style="line-height: 3vh;">
                <span style="display: inline-block;padding:0 0 0 3px; width: 100%;height: 3vh;text-align: left;border-radius: 3px; border: 1px solid #EEEEEE">￥{{detailThreeReport.valuationResult}}</span>
              </Col>
            </Col>
          </Row>
          <Row style="margin: 0.5vh">
            <Col span="10">
              ...
              <Col span="12" style="line-height: 3vh">
                <span style="display: inline-block;padding:0 0 0 3px; width: 100%;height: 3vh;text-align: left;border-radius: 3px; border: 1px solid #EEEEEE">{{detailThreeReport.valuer1}}</span>
              </Col>
            </Col>
            <Col span="10">
              <Col span="6" style="line-height: 3vh;text-align: right">
              ...
              <Col span="12" style="line-height: 3vh">
                <span style="display: inline-block;padding:0 0 0 3px; width: 100%;height: 3vh;text-align: left;border-radius: 3px; border: 1px solid #EEEEEE">{{detailThreeReport.valuer2}}</span>
              </Col>
            </Col>
          ...
          <Row style="margin: 0.5vh">
            <Col span="10">
              ...
              <Col span="12" style="line-height: 3vh">
                <span style="display: inline-block;padding:0 0 0 3px; width: 100%;height: 3vh;text-align: left;border-radius: 3px; border: 1px solid #EEEEEE">{{detailThreeReport.valuationDate}}</span>
              </Col>
            </Col>
            <Col span="10">
              <Col span="6" style="line-height: 3vh;text-align: right">
              ...
              <Col span="12" style="line-height: 3vh">
                <span style="display: inline-block;padding:0 0 0 3px; width: 100%;height: 3vh;text-align: left;border-radius: 3px; border: 1px solid #EEEEEE">{{detailThreeReport.valuationValidityBegin}}</span>
              </Col>
            </Col>
          </Row>
          <Row style="margin: 0.5vh">
            <Col span="10">
              ...
              <Col span="12" style="line-height: 3vh">
                <span style="display: inline-block;padding:0 0 0 3px; width: 100%;height: 3vh;text-align: left;border-radius: 3px; border: 1px solid #EEEEEE">{{detailThreeReport.auditor2Uuid}}</span>
              </Col>
            </Col>
            <Col span="10">
              <Col span="6" style="line-height: 3vh;text-align: right">
              ...
              <Col span="12" style="line-height: 3vh">
                <span style="display: inline-block;padding:0 0 0 3px; width: 100%;height: 3vh;text-align: left;border-radius: 3px; border: 1px solid #EEEEEE">{{detailThreeReport.auditor3Number}}</span>
              </Col>
            </Col>
          </Row>
          <Row style="margin: 0.5vh">
            <Col span="10">
              ...
              <Col span="12">
                <span style="display: inline-block;padding:0 0 0 3px; width: 100%;height: 3vh;text-align: left;border-radius: 3px; border: 1px solid #EEEEEE">{{detailThreeReport.projectPrincipalNumber}}</span>
              </Col>
            </Col>
            <Col span="10">
              <Col span="6" style="line-height: 3vh;text-align: right">
              ...
              <Col span="12">
                <span style="display: inline-block;padding:0 0 0 3px; width: 100%;height: 3vh;text-align: left;border-radius: 3px; border: 1px solid #EEEEEE">{{detailThreeReport.cost}}</span>
              </Col>
            </Col>
          </Row>
          <Row>
          ...
          <Row>
            <Col span="12">
              ...
              <Col span="3" style="line-height: 3vh">
                <span style="display: inline-block;width: 18vw;height: 3vh;border-radius: 3px;text-align: left">{{detailThreeReport.mandatorName}}</span>
              </Col>
            </Col>
            <Col span="12">
              ...
              <Col span="3" style="line-height: 3vh">
                <span style="display: inline-block;width: 320%;height: 3vh;border-radius: 3px;text-align: left">{{detailThreeReport.mandatorIdentityCard}}</span>
              </Col>
            </Col>
          </Row>
          <Row style="margin-top: 2vh">
            <Col span="12">
              ...
              <Col span="10">
                <span style="display: inline-block;width: 300%;height: 3vh;border-radius: 3px;text-align: left">{{detailThreeReport.excerpt}}</span>
              </Col>
            </Col>
          </Row>
        </div>
